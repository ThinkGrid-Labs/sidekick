...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/flags/:key", get(get_flag).delete(delete_flag).patch(patch_flag))
}
...
async fn patch_flag(
    ...
    let mut flag_val: serde_json::Value = rec.try_get("data").map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
    ...
    let flag: Flag = serde_json::from_value(flag_val.clone())
